...
T = TypeVar("T", bound="EnableOfflineRequest")


@_attrs_define
class EnableOfflineRequest:
    """
    Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        bundle_source_path = self.bundle_source_path
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        bundle_source_path = d.pop("bundle_source_path")
        ...
        enable_offline_request = cls(
            bundle_source_path=bundle_source_path,
            org_id=org_id,
            subscription_id=subscription_id,
        )

        enable_offline_request.additional_properties = d
        return enable_offline_request
