...
T = TypeVar("T", bound="RAGIngestRequest")
...
class RAGIngestRequest:
    """
    Attributes:
        domains (list[str] | None | Unset): Domains to ingest: findings, remediation, activity. Null = all.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rag_ingest_request = cls(
            domains=domains,
        )

        rag_ingest_request.additional_properties = d
        return rag_ingest_request
