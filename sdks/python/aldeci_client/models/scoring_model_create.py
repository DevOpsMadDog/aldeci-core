...
T = TypeVar("T", bound="ScoringModelCreate")


@_attrs_define
class ScoringModelCreate:
    """
    Attributes:
        model_name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scoring_model_create.additional_properties = d
        return scoring_model_create
