...
T = TypeVar("T", bound="DeliverNotificationRequest")


@_attrs_define
class DeliverNotificationRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        deliver_notification_request = cls(
        ...
        deliver_notification_request.additional_properties = d
