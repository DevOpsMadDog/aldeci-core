...
T = TypeVar("T", bound="NoticeFileRequest")


@_attrs_define
class NoticeFileRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        notice_file_request = cls(
            components=components,
        )

        notice_file_request.additional_properties = d
        return notice_file_request
