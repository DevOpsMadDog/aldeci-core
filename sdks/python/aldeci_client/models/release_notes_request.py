...
T = TypeVar("T", bound="ReleaseNotesRequest")
...
class ReleaseNotesRequest:
    ...
    Attributes:
        ...
        version (str | Unset): Version label Default: '1.0.0'.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        release_notes_request = cls(
            commits=commits,
            version=version,
        )

        release_notes_request.additional_properties = d
