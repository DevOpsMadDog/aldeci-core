...
T = TypeVar("T", bound="RecordVerificationRequest")
...
class RecordVerificationRequest:
    """
    Attributes:
        backup_job_id (str): Backup job this verification covers
        backup_artifact_path (str): Path or URI to the backup artifact
        sha256_checksum (None | str | Unset): SHA-256 hash of the artifact
        checksum_verified (bool | Unset): Was the checksum validated? Default: False.
        restore_tested (bool | Unset): Was a restore test performed? Default: False.
        restore_test_result (VerificationStatus | Unset):
        restore_test_duration_seconds (int | None | Unset):
        backup_age_hours (float | None | Unset): Age of the backup in hours
        age_alert_threshold_hours (float | Unset): Hours before age alert fires Default: 48.0.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        record_verification_request = cls(
            backup_job_id=backup_job_id,
            backup_artifact_path=backup_artifact_path,
        ...
        record_verification_request.additional_properties = d
        return record_verification_request
