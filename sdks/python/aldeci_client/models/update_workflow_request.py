...
if TYPE_CHECKING:
    ...
    from ..models.workflow_condition_request import WorkflowConditionRequest
...
class UpdateWorkflowRequest:
    ...
    Attributes:
        ...
        trigger (None | TriggerType | Unset):
        conditions (list[WorkflowConditionRequest] | None | Unset):
        actions (list[WorkflowActionRequest] | None | Unset):
        enabled (bool | None | Unset):
    """

    name: None | str | Unset = UNSET
    description: None | str | Unset = UNSET
    trigger: None | TriggerType | Unset = UNSET
    conditions: list[WorkflowConditionRequest] | None | Unset = UNSET
    actions: list[WorkflowActionRequest] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.trigger, Unset):
            trigger = UNSET
        elif isinstance(self.trigger, TriggerType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_trigger(data: object) -> None | TriggerType | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                trigger_type_0 = TriggerType(data)
        ...
        def _parse_conditions(data: object) -> list[WorkflowConditionRequest] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for conditions_type_0_item_data in _conditions_type_0:
                    conditions_type_0_item = WorkflowConditionRequest.from_dict(conditions_type_0_item_data)
                ...
                pass
            return cast(list[WorkflowConditionRequest] | None | Unset, data)

        conditions = _parse_conditions(d.pop("conditions", UNSET))

        def _parse_actions(data: object) -> list[WorkflowActionRequest] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for actions_type_0_item_data in _actions_type_0:
                    actions_type_0_item = WorkflowActionRequest.from_dict(actions_type_0_item_data)
                ...
                pass
            return cast(list[WorkflowActionRequest] | None | Unset, data)
