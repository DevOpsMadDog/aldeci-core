...
T = TypeVar("T", bound="ExecutiveReportRequest")


@_attrs_define
class ExecutiveReportRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        executive_report_request = cls(
            org_id=org_id,
            period_days=period_days,
        )

        executive_report_request.additional_properties = d
        return executive_report_request
