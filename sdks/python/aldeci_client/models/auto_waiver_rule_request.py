...
if TYPE_CHECKING:
    from ..models.auto_waiver_rule_request_conditions import AutoWaiverRuleRequestConditions


T = TypeVar("T", bound="AutoWaiverRuleRequest")


@_attrs_define
class AutoWaiverRuleRequest:
    """
    Attributes:
        rule_key (str):
        conditions (AutoWaiverRuleRequestConditions | Unset):
    ...
    rule_key: str
    conditions: AutoWaiverRuleRequestConditions | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_conditions, Unset):
            ...
            conditions = AutoWaiverRuleRequestConditions.from_dict(_conditions)
        ...
        auto_waiver_rule_request.additional_properties = d
        return auto_waiver_rule_request
