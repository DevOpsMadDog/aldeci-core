...
T = TypeVar("T", bound="SplitClusterRequest")


@_attrs_define
class SplitClusterRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        split_cluster_request = cls(
            event_ids=event_ids,
            reason=reason,
        )

        split_cluster_request.additional_properties = d
        return split_cluster_request
