...
T = TypeVar("T", bound="SubsystemStatus")
...
class SubsystemStatus:
    ...
    Attributes:
        name (str):
        healthy (bool):
        latency_ms (float | Unset):  Default: 0.0.
        detail (None | str | Unset):
    """

    name: str
    healthy: bool
    latency_ms: float | Unset = 0.0
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        subsystem_status.additional_properties = d
