...
class BatchTraceRequest:
    ...
    Attributes:
        vulnerabilities (list[TraceRequest]): List of vulnerabilities to trace
    """

    vulnerabilities: list[TraceRequest]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for vulnerabilities_item_data in _vulnerabilities:
            vulnerabilities_item = TraceRequest.from_dict(vulnerabilities_item_data)
