...
class CreateApiKeyRequest:
    ...
    Attributes:
        ...
        owner_id (str | Unset): Owner user/service ID Default: ''.
        scopes (list[str] | Unset): Permission scopes
        rate_limit_per_hour (int | Unset): Rate limit per hour Default: 1000.
        expires_at (None | str | Unset): ISO expiry timestamp
    """
