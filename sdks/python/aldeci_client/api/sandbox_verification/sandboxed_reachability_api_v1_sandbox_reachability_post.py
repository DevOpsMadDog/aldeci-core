...
from ...models.reachability_probe_request import ReachabilityProbeRequest
from ...types import Response


def _get_kwargs(
    *,
    body: ReachabilityProbeRequest,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (ReachabilityProbeRequest): Request model for reachability probing.
