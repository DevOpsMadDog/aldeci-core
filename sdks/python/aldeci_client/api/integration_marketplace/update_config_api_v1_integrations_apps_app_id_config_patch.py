...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/api/v1/integrations/apps/{app_id}/config".format(
...
) -> HTTPValidationError | InstalledApp | None:
    if response.status_code == 200:
        response_200 = InstalledApp.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | InstalledApp]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (UpdateConfigRequest): Request body for updating installed app configuration.
...
def sync(
    ...
    *,
    ...
    Returns:
        HTTPValidationError | InstalledApp
    """
