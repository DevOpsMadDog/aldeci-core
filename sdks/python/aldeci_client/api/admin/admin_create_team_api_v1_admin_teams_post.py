...
from ...models.admin_team_create import AdminTeamCreate
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = AdminTeamResponse.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        body (AdminTeamCreate): Request model for creating a team via admin API.
