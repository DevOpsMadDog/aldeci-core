...
from ...models.triage_stats_response import TriageStatsResponse
...
) -> HTTPValidationError | TriageStatsResponse | None:
    if response.status_code == 200:
        response_200 = TriageStatsResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | TriageStatsResponse]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | TriageStatsResponse
    """
