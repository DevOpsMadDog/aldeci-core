...
from ...models.body_sso_callback_api_v1_auth_sso_provider_callback_post import (
...
def _get_kwargs(
    provider: str,
    *,
    body: BodySsoCallbackApiV1AuthSsoProviderCallbackPost | Unset = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (BodySsoCallbackApiV1AuthSsoProviderCallbackPost | Unset):
