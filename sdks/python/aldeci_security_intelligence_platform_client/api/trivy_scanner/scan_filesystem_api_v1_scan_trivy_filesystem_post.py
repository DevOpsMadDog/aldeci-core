...
from ...models.scan_filesystem_request import ScanFilesystemRequest
from ...types import Response


def _get_kwargs(
    *,
    body: ScanFilesystemRequest,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (ScanFilesystemRequest): Request body for scanning a filesystem path.
