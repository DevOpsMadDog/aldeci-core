...
from ...models.bulk_apply_policies_request import BulkApplyPoliciesRequest
...
def sync_detailed(
    *,
    ...
    Args:
        body (BulkApplyPoliciesRequest): Request model for bulk policy application.
