...
from ...models.bulk_accept_risk_request import BulkAcceptRiskRequest
...
def sync_detailed(
    *,
    ...
    Args:
        body (BulkAcceptRiskRequest): Request model for bulk accept risk.
