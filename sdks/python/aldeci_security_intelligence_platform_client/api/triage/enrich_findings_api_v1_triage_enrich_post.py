...
from ...models.triage_enrich_request import TriageEnrichRequest
from ...models.triage_enrich_response import TriageEnrichResponse
...
) -> HTTPValidationError | TriageEnrichResponse | None:
    if response.status_code == 200:
        response_200 = TriageEnrichResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | TriageEnrichResponse]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        body (TriageEnrichRequest): Request body for /enrich — single finding or batch.
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | TriageEnrichResponse
    """
