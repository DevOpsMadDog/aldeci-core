...
def _get_kwargs(
    *,
    ...
    exploitability: None | str | Unset = UNSET,
    limit: int | Unset = 100,
    offset: int | Unset = 0,
    ...
    json_exploitability: None | str | Unset
    if isinstance(exploitability, Unset):
        json_exploitability = UNSET
    else:
        json_exploitability = exploitability
    params["exploitability"] = json_exploitability
