...
from ...models.auto_verify_api_v1_webhooks_verify_post_response_auto_verify_api_v1_webhooks_verify_post import (
...
) -> AutoVerifyApiV1WebhooksVerifyPostResponseAutoVerifyApiV1WebhooksVerifyPost | HTTPValidationError | None:
    if response.status_code == 200:
        response_200 = AutoVerifyApiV1WebhooksVerifyPostResponseAutoVerifyApiV1WebhooksVerifyPost.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[AutoVerifyApiV1WebhooksVerifyPostResponseAutoVerifyApiV1WebhooksVerifyPost | HTTPValidationError]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        AutoVerifyApiV1WebhooksVerifyPostResponseAutoVerifyApiV1WebhooksVerifyPost | HTTPValidationError
    """
