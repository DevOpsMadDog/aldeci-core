...
T = TypeVar("T", bound="BodySsoCallbackApiV1AuthSsoProviderCallbackPost")


@_attrs_define
class BodySsoCallbackApiV1AuthSsoProviderCallbackPost:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        body_sso_callback_api_v1_auth_sso_provider_callback_post = cls(
            saml_response=saml_response,
            relay_state=relay_state,
        )

        body_sso_callback_api_v1_auth_sso_provider_callback_post.additional_properties = d
        return body_sso_callback_api_v1_auth_sso_provider_callback_post
