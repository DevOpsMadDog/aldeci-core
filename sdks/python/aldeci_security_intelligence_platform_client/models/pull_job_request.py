...
T = TypeVar("T", bound="PullJobRequest")
...
class PullJobRequest:
    ...
    Attributes:
        since (datetime.datetime | None | Unset): Pull findings modified since this timestamp (optional)
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pull_job_request = cls(
            since=since,
        )

        pull_job_request.additional_properties = d
        return pull_job_request
