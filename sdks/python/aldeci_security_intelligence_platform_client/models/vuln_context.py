...
class VulnContext:
    """
    Attributes:
        asset_criticality (str | Unset): Asset criticality: critical | high | medium | low Default: 'medium'.
        ...
        kev (bool | Unset): CISA Known Exploited Vulnerability Default: False.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        vuln_context.additional_properties = d
        return vuln_context
