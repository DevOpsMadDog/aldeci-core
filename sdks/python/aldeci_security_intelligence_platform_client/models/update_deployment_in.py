...
T = TypeVar("T", bound="UpdateDeploymentIn")


@_attrs_define
class UpdateDeploymentIn:
    """
    Attributes:
        status (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_deployment_in = cls(
            status=status,
            error_msg=error_msg,
        )

        update_deployment_in.additional_properties = d
        return update_deployment_in
