...
T = TypeVar("T", bound="BodyRegisterArtifactMultipartApiV1BinaryFpRegisterPost")


@_attrs_define
class BodyRegisterArtifactMultipartApiV1BinaryFpRegisterPost:
    """
    Attributes:
        org_id (str):
        artifact_ref (str | Unset):  Default: ''.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        body_register_artifact_multipart_api_v1_binary_fp_register_post = cls(
            org_id=org_id,
        ...
        body_register_artifact_multipart_api_v1_binary_fp_register_post.additional_properties = d
        return body_register_artifact_multipart_api_v1_binary_fp_register_post
