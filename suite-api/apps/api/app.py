...
def create_app() -> FastAPI:
    ...
    # ── AUTO-MOUNTED ROUTERS (2026-05-09) — resurrects 175+ previously-404 UI paths ──
    # Generated by backend-hardener: matched unmounted router files to broken UI paths.
    # Each block is try/except so a single broken import never kills the app.
    try:
        from apps.api.auth_router import router as _auto_auth_router
        app.include_router(_auto_auth_router)
        _logger.info('Mounted auth_router at /api/v1/auth (5 paths)')
    except Exception as _e:
        _logger.warning('auth_router unavailable: %s', _e)
    try:
        from apps.api.kpi_router import router as _auto_kpi_router
        app.include_router(_auto_kpi_router)
        _logger.info('Mounted kpi_router at /api/v1/kpis (5 paths)')
    except Exception as _e:
        _logger.warning('kpi_router unavailable: %s', _e)
    try:
        from apps.api.bulk_router import router as _auto_bulk_router
        app.include_router(_auto_bulk_router)
        _logger.info('Mounted bulk_router at /api/v1/bulk (4 paths)')
    except Exception as _e:
        _logger.warning('bulk_router unavailable: %s', _e)
    try:
        from apps.api.security_kpi_router import router as _auto_security_kpi_router
        app.include_router(_auto_security_kpi_router)
        _logger.info('Mounted security_kpi_router at /api/v1/kpi (4 paths)')
    except Exception as _e:
        _logger.warning('security_kpi_router unavailable: %s', _e)
    try:
        from apps.api.ai_security_advisor_router import router as _auto_ai_security_advisor_router
        app.include_router(_auto_ai_security_advisor_router)
        _logger.info('Mounted ai_security_advisor_router at /api/v1/ai-advisor (3 paths)')
    except Exception as _e:
        _logger.warning('ai_security_advisor_router unavailable: %s', _e)
    try:
        from apps.api.analytics_router import router as _auto_analytics_router
        app.include_router(_auto_analytics_router)
        _logger.info('Mounted analytics_router at /api/v1/analytics (3 paths)')
    except Exception as _e:
        _logger.warning('analytics_router unavailable: %s', _e)
    try:
        from apps.api.api_security_router import router as _auto_api_security_router
        app.include_router(_auto_api_security_router)
        _logger.info('Mounted api_security_router at /api/v1/api-security (3 paths)')
    except Exception as _e:
        _logger.warning('api_security_router unavailable: %s', _e)
    try:
        from apps.api.autofix_router import router as _auto_autofix_router
        app.include_router(_auto_autofix_router)
        _logger.info('Mounted autofix_router at /api/v1/autofix (3 paths)')
    except Exception as _e:
        _logger.warning('autofix_router unavailable: %s', _e)
    try:
        from apps.api.binary_fingerprint_router import router as _auto_binary_fingerprint_router
        app.include_router(_auto_binary_fingerprint_router)
        _logger.info('Mounted binary_fingerprint_router at /api/v1/binary-fp (3 paths)')
    except Exception as _e:
        _logger.warning('binary_fingerprint_router unavailable: %s', _e)
    try:
        from apps.api.certificate_lifecycle_router import router as _auto_certificate_lifecycle_router
        app.include_router(_auto_certificate_lifecycle_router)
        _logger.info('Mounted certificate_lifecycle_router at /api/v1/certificates (3 paths)')
    except Exception as _e:
        _logger.warning('certificate_lifecycle_router unavailable: %s', _e)
    try:
        from apps.api.digital_identity_router import router as _auto_digital_identity_router
        app.include_router(_auto_digital_identity_router)
        _logger.info('Mounted digital_identity_router at /api/v1/digital-identity (3 paths)')
    except Exception as _e:
        _logger.warning('digital_identity_router unavailable: %s', _e)
    try:
        from apps.api.dynamic_rule_dsl_router import router as _auto_dynamic_rule_dsl_router
        app.include_router(_auto_dynamic_rule_dsl_router)
        _logger.info('Mounted dynamic_rule_dsl_router at /api/v1/rules/dsl (3 paths)')
    except Exception as _e:
        _logger.warning('dynamic_rule_dsl_router unavailable: %s', _e)
    try:
        from apps.api.feeds_router import router as _auto_feeds_router
        app.include_router(_auto_feeds_router)
        _logger.info('Mounted feeds_router at /api/v1/feeds (3 paths)')
    except Exception as _e:
        _logger.warning('feeds_router unavailable: %s', _e)
    try:
        from apps.api.ide_router import router as _auto_ide_router
        app.include_router(_auto_ide_router)
        _logger.info('Mounted ide_router at /api/v1/ide (3 paths)')
    except Exception as _e:
        _logger.warning('ide_router unavailable: %s', _e)
    try:
        from apps.api.pipeline_router import router as _auto_pipeline_router
        app.include_router(_auto_pipeline_router)
        _logger.info('Mounted pipeline_router at /api/v1/brain (3 paths)')
    except Exception as _e:
        _logger.warning('pipeline_router unavailable: %s', _e)
    try:
        from apps.api.policy_enforcement_router import router as _auto_policy_enforcement_router
        app.include_router(_auto_policy_enforcement_router)
        _logger.info('Mounted policy_enforcement_router at /api/v1/policy-enforcement (3 paths)')
    except Exception as _e:
        _logger.warning('policy_enforcement_router unavailable: %s', _e)
    try:
        from apps.api.posture_score_router import router as _auto_posture_score_router
        app.include_router(_auto_posture_score_router)
        _logger.info('Mounted posture_score_router at /api/v1/posture-score (3 paths)')
    except Exception as _e:
        _logger.warning('posture_score_router unavailable: %s', _e)
    try:
        from apps.api.security_capacity_planning_router import router as _auto_security_capacity_planning_router
        app.include_router(_auto_security_capacity_planning_router)
        _logger.info('Mounted security_capacity_planning_router at /api/v1/capacity-planning (3 paths)')
    except Exception as _e:
        _logger.warning('security_capacity_planning_router unavailable: %s', _e)
    try:
        from apps.api.security_event_timeline_router import router as _auto_security_event_timeline_router
        app.include_router(_auto_security_event_timeline_router)
        _logger.info('Mounted security_event_timeline_router at /api/v1/event-timeline (3 paths)')
    except Exception as _e:
        _logger.warning('security_event_timeline_router unavailable: %s', _e)
    try:
        from apps.api.security_gap_analysis_router import router as _auto_security_gap_analysis_router
        app.include_router(_auto_security_gap_analysis_router)
        _logger.info('Mounted security_gap_analysis_router at /api/v1/gap-analysis (3 paths)')
    except Exception as _e:
        _logger.warning('security_gap_analysis_router unavailable: %s', _e)
    try:
        from apps.api.air_gap_bundle_router import router as _auto_air_gap_bundle_router
        app.include_router(_auto_air_gap_bundle_router)
        _logger.info('Mounted air_gap_bundle_router at /api/v1/air-gap (2 paths)')
    except Exception as _e:
        _logger.warning('air_gap_bundle_router unavailable: %s', _e)
    try:
        from apps.api.alert_enrichment_router import router as _auto_alert_enrichment_router
        app.include_router(_auto_alert_enrichment_router)
        _logger.info('Mounted alert_enrichment_router at /api/v1/alert-enrichment (2 paths)')
    except Exception as _e:
        _logger.warning('alert_enrichment_router unavailable: %s', _e)
    try:
        from apps.api.api_threat_protection_router import router as _auto_api_threat_protection_router
        app.include_router(_auto_api_threat_protection_router)
        _logger.info('Mounted api_threat_protection_router at /api/v1/api-threat-protection (2 paths)')
    except Exception as _e:
        _logger.warning('api_threat_protection_router unavailable: %s', _e)
    try:
        from apps.api.attack_surface_router import router as _auto_attack_surface_router
        app.include_router(_auto_attack_surface_router)
        _logger.info('Mounted attack_surface_router at /api/v1/attack-surface (2 paths)')
    except Exception as _e:
        _logger.warning('attack_surface_router unavailable: %s', _e)
    try:
        from apps.api.ciso_report_router import router as _auto_ciso_report_router
        app.include_router(_auto_ciso_report_router)
        _logger.info('Mounted ciso_report_router at /api/v1/ciso-report (2 paths)')
    except Exception as _e:
        _logger.warning('ciso_report_router unavailable: %s', _e)
    try:
        from apps.api.cloud_security_findings_router import router as _auto_cloud_security_findings_router
        app.include_router(_auto_cloud_security_findings_router)
        _logger.info('Mounted cloud_security_findings_router at /api/v1/cloud-findings (2 paths)')
    except Exception as _e:
        _logger.warning('cloud_security_findings_router unavailable: %s', _e)
    try:
        from apps.api.cloud_security_router import router as _auto_cloud_security_router
        app.include_router(_auto_cloud_security_router)
        _logger.info('Mounted cloud_security_router at /api/v1/cloud-security (2 paths)')
    except Exception as _e:
        _logger.warning('cloud_security_router unavailable: %s', _e)
    try:
        from apps.api.evidence_vault_router import router as _auto_evidence_vault_router
        app.include_router(_auto_evidence_vault_router)
        _logger.info('Mounted evidence_vault_router at /api/v1/evidence-vault (2 paths)')
    except Exception as _e:
        _logger.warning('evidence_vault_router unavailable: %s', _e)
    try:
        from apps.api.fips_router import router as _auto_fips_router
        app.include_router(_auto_fips_router)
        _logger.info('Mounted fips_router at /api/v1/fips (2 paths)')
    except Exception as _e:
        _logger.warning('fips_router unavailable: %s', _e)
    try:
        from apps.api.function_reachability_router import router as _auto_function_reachability_router
        app.include_router(_auto_function_reachability_router)
        _logger.info('Mounted function_reachability_router at /api/v1/reachability (2 paths)')
    except Exception as _e:
        _logger.warning('function_reachability_router unavailable: %s', _e)
    try:
        from apps.api.hunting_automation_router import router as _auto_hunting_automation_router
        app.include_router(_auto_hunting_automation_router)
        _logger.info('Mounted hunting_automation_router at /api/v1/hunting-automation (2 paths)')
    except Exception as _e:
        _logger.warning('hunting_automation_router unavailable: %s', _e)
    try:
        from apps.api.identity_analytics_router import router as _auto_identity_analytics_router
        app.include_router(_auto_identity_analytics_router)
        _logger.info('Mounted identity_analytics_router at /api/v1/identity-analytics (2 paths)')
    except Exception as _e:
        _logger.warning('identity_analytics_router unavailable: %s', _e)
    try:
        from apps.api.identity_lifecycle_router import router as _auto_identity_lifecycle_router
        app.include_router(_auto_identity_lifecycle_router)
        _logger.info('Mounted identity_lifecycle_router at /api/v1/identity-lifecycle (2 paths)')
    except Exception as _e:
        _logger.warning('identity_lifecycle_router unavailable: %s', _e)
    try:
        from apps.api.incident_cost_router import router as _auto_incident_cost_router
        app.include_router(_auto_incident_cost_router)
        _logger.info('Mounted incident_cost_router at /api/v1/incident-costs (2 paths)')
    except Exception as _e:
        _logger.warning('incident_cost_router unavailable: %s', _e)
    try:
        from apps.api.ir_playbook_router import router as _auto_ir_playbook_router
        app.include_router(_auto_ir_playbook_router)
        _logger.info('Mounted ir_playbook_router at /api/v1/ir (2 paths)')
    except Exception as _e:
        _logger.warning('ir_playbook_router unavailable: %s', _e)
    try:
        from apps.api.llm_router import router as _auto_llm_router
        app.include_router(_auto_llm_router)
        _logger.info('Mounted llm_router at /api/v1/llm (2 paths)')
    except Exception as _e:
        _logger.warning('llm_router unavailable: %s', _e)
    try:
        from apps.api.local_file_store_router import router as _auto_local_file_store_router
        app.include_router(_auto_local_file_store_router)
        _logger.info('Mounted local_file_store_router at /api/v1/local-store (2 paths)')
    except Exception as _e:
        _logger.warning('local_file_store_router unavailable: %s', _e)
    try:
        from apps.api.mpte_orchestrator_router import router as _auto_mpte_orchestrator_router
        app.include_router(_auto_mpte_orchestrator_router)
        _logger.info('Mounted mpte_orchestrator_router at /api/v1/mpte-orchestrator (2 paths)')
    except Exception as _e:
        _logger.warning('mpte_orchestrator_router unavailable: %s', _e)
    try:
        from apps.api.ransomware_protection_router import router as _auto_ransomware_protection_router
        app.include_router(_auto_ransomware_protection_router)
        _logger.info('Mounted ransomware_protection_router at /api/v1/ransomware-protection (2 paths)')
    except Exception as _e:
        _logger.warning('ransomware_protection_router unavailable: %s', _e)
    try:
        from apps.api.security_awareness_program_router import router as _auto_security_awareness_program_router
        app.include_router(_auto_security_awareness_program_router)
        _logger.info('Mounted security_awareness_program_router at /api/v1/awareness-program (2 paths)')
    except Exception as _e:
        _logger.warning('security_awareness_program_router unavailable: %s', _e)
    try:
        from apps.api.security_exception_workflow_router import router as _auto_security_exception_workflow_router
        app.include_router(_auto_security_exception_workflow_router)
        _logger.info('Mounted security_exception_workflow_router at /api/v1/exception-workflow (2 paths)')
    except Exception as _e:
        _logger.warning('security_exception_workflow_router unavailable: %s', _e)
    try:
        from apps.api.security_posture_history_router import router as _auto_security_posture_history_router
        app.include_router(_auto_security_posture_history_router)
        _logger.info('Mounted security_posture_history_router at /api/v1/posture-history (2 paths)')
    except Exception as _e:
        _logger.warning('security_posture_history_router unavailable: %s', _e)
    try:
        from apps.api.security_posture_maturity_router import router as _auto_security_posture_maturity_router
        app.include_router(_auto_security_posture_maturity_router)
        _logger.info('Mounted security_posture_maturity_router at /api/v1/posture-maturity (2 paths)')
    except Exception as _e:
        _logger.warning('security_posture_maturity_router unavailable: %s', _e)
    try:
        from apps.api.threat_actor_tracking_router import router as _auto_threat_actor_tracking_router
        app.include_router(_auto_threat_actor_tracking_router)
        _logger.info('Mounted threat_actor_tracking_router at /api/v1/actor-tracking (2 paths)')
    except Exception as _e:
        _logger.warning('threat_actor_tracking_router unavailable: %s', _e)
    try:
        from apps.api.access_anomaly_router import router as _auto_access_anomaly_router
        app.include_router(_auto_access_anomaly_router)
        _logger.info('Mounted access_anomaly_router at /api/v1/access-anomaly (1 paths)')
    except Exception as _e:
        _logger.warning('access_anomaly_router unavailable: %s', _e)
    try:
        from apps.api.access_request_management_router import router as _auto_access_request_management_router
        app.include_router(_auto_access_request_management_router)
        _logger.info('Mounted access_request_management_router at /api/v1/access-requests (1 paths)')
    except Exception as _e:
        _logger.warning('access_request_management_router unavailable: %s', _e)
    try:
        from apps.api.airgap_router import router as _auto_airgap_router
        app.include_router(_auto_airgap_router)
        _logger.info('Mounted airgap_router at /api/v1/airgap (1 paths)')
    except Exception as _e:
        _logger.warning('airgap_router unavailable: %s', _e)
    try:
        from apps.api.api_discovery_router import router as _auto_api_discovery_router
        app.include_router(_auto_api_discovery_router)
        _logger.info('Mounted api_discovery_router at /api/v1/api-discovery (1 paths)')
    except Exception as _e:
        _logger.warning('api_discovery_router unavailable: %s', _e)
    try:
        from apps.api.app_security_router import router as _auto_app_security_router
        app.include_router(_auto_app_security_router)
        _logger.info('Mounted app_security_router at /api/v1/app-security (1 paths)')
    except Exception as _e:
        _logger.warning('app_security_router unavailable: %s', _e)
    try:
        from apps.api.arch_graph_router import router as _auto_arch_graph_router
        app.include_router(_auto_arch_graph_router)
        _logger.info('Mounted arch_graph_router at /api/v1/arch-graph (1 paths)')
    except Exception as _e:
        _logger.warning('arch_graph_router unavailable: %s', _e)
    try:
        from apps.api.attack_path_router import router as _auto_attack_path_router
        app.include_router(_auto_attack_path_router)
        _logger.info('Mounted attack_path_router at /api/v1/attack-paths (1 paths)')
    except Exception as _e:
        _logger.warning('attack_path_router unavailable: %s', _e)
    try:
        from apps.api.attack_simulation_router import router as _auto_attack_simulation_router
        app.include_router(_auto_attack_simulation_router)
        _logger.info('Mounted attack_simulation_router at /api/v1/attack-sim (1 paths)')
    except Exception as _e:
        _logger.warning('attack_simulation_router unavailable: %s', _e)
    try:
        from apps.api.browser_security_router import router as _auto_browser_security_router
        app.include_router(_auto_browser_security_router)
        _logger.info('Mounted browser_security_router at /api/v1/browser-security (1 paths)')
    except Exception as _e:
        _logger.warning('browser_security_router unavailable: %s', _e)
    try:
        from apps.api.cloud_account_monitoring_router import router as _auto_cloud_account_monitoring_router
        app.include_router(_auto_cloud_account_monitoring_router)
        _logger.info('Mounted cloud_account_monitoring_router at /api/v1/cloud-accounts (1 paths)')
    except Exception as _e:
        _logger.warning('cloud_account_monitoring_router unavailable: %s', _e)
    try:
        from apps.api.cloud_compliance_router import router as _auto_cloud_compliance_router
        app.include_router(_auto_cloud_compliance_router)
        _logger.info('Mounted cloud_compliance_router at /api/v1/cloud-compliance (1 paths)')
    except Exception as _e:
        _logger.warning('cloud_compliance_router unavailable: %s', _e)
    try:
        from apps.api.cloud_posture_router import router as _auto_cloud_posture_router
        app.include_router(_auto_cloud_posture_router)
        _logger.info('Mounted cloud_posture_router at /api/v1/cloud-posture (1 paths)')
    except Exception as _e:
        _logger.warning('cloud_posture_router unavailable: %s', _e)
    try:
        from apps.api.cloud_security_analytics_router import router as _auto_cloud_security_analytics_router
        app.include_router(_auto_cloud_security_analytics_router)
        _logger.info('Mounted cloud_security_analytics_router at /api/v1/cloud-analytics (1 paths)')
    except Exception as _e:
        _logger.warning('cloud_security_analytics_router unavailable: %s', _e)
    try:
        from apps.api.digital_forensics_router import router as _auto_digital_forensics_router
        app.include_router(_auto_digital_forensics_router)
        _logger.info('Mounted digital_forensics_router at /api/v1/digital-forensics (1 paths)')
    except Exception as _e:
        _logger.warning('digital_forensics_router unavailable: %s', _e)
    try:
        from apps.api.digital_twin_security_router import router as _auto_digital_twin_security_router
        app.include_router(_auto_digital_twin_security_router)
        _logger.info('Mounted digital_twin_security_router at /api/v1/digital-twin (1 paths)')
    except Exception as _e:
        _logger.warning('digital_twin_security_router unavailable: %s', _e)
    try:
        from apps.api.dlp_router import router as _auto_dlp_router
        app.include_router(_auto_dlp_router)
        _logger.info('Mounted dlp_router at /api/v1/dlp (1 paths)')
    except Exception as _e:
        _logger.warning('dlp_router unavailable: %s', _e)
    try:
        from apps.api.endpoint_threat_hunting_router import router as _auto_endpoint_threat_hunting_router
        app.include_router(_auto_endpoint_threat_hunting_router)
        _logger.info('Mounted endpoint_threat_hunting_router at /api/v1/endpoint-hunting (1 paths)')
    except Exception as _e:
        _logger.warning('endpoint_threat_hunting_router unavailable: %s', _e)
    try:
        from apps.api.executive_reporting_router import router as _auto_executive_reporting_router
        app.include_router(_auto_executive_reporting_router)
        _logger.info('Mounted executive_reporting_router at /api/v1/exec-reporting (1 paths)')
    except Exception as _e:
        _logger.warning('executive_reporting_router unavailable: %s', _e)
    try:
        from apps.api.export_router import router as _auto_export_router
        app.include_router(_auto_export_router)
        _logger.info('Mounted export_router at /api/v1/export (1 paths)')
    except Exception as _e:
        _logger.warning('export_router unavailable: %s', _e)
    try:
        from apps.api.fair_per_bu_router import router as _auto_fair_per_bu_router
        app.include_router(_auto_fair_per_bu_router)
        _logger.info('Mounted fair_per_bu_router at /api/v1/fair (1 paths)')
    except Exception as _e:
        _logger.warning('fair_per_bu_router unavailable: %s', _e)
    try:
        from apps.api.findings_lifecycle_router import router as _auto_findings_lifecycle_router
        app.include_router(_auto_findings_lifecycle_router)
        _logger.info('Mounted findings_lifecycle_router at /api/v1/findings/lifecycle (1 paths)')
    except Exception as _e:
        _logger.warning('findings_lifecycle_router unavailable: %s', _e)
    try:
        from apps.api.firewall_policy_router import router as _auto_firewall_policy_router
        app.include_router(_auto_firewall_policy_router)
        _logger.info('Mounted firewall_policy_router at /api/v1/firewall-policy (1 paths)')
    except Exception as _e:
        _logger.warning('firewall_policy_router unavailable: %s', _e)
    try:
        from apps.api.gdpr_compliance_router import router as _auto_gdpr_compliance_router
        app.include_router(_auto_gdpr_compliance_router)
        _logger.info('Mounted gdpr_compliance_router at /api/v1/gdpr (1 paths)')
    except Exception as _e:
        _logger.warning('gdpr_compliance_router unavailable: %s', _e)
    try:
        from apps.api.github_app_router import router as _auto_github_app_router
        app.include_router(_auto_github_app_router)
        _logger.info('Mounted github_app_router at /api/v1/github-app (1 paths)')
    except Exception as _e:
        _logger.warning('github_app_router unavailable: %s', _e)
    try:
        from apps.api.grc_router import router as _auto_grc_router
        app.include_router(_auto_grc_router)
        _logger.info('Mounted grc_router at /api/v1/grc (1 paths)')
    except Exception as _e:
        _logger.warning('grc_router unavailable: %s', _e)
    try:
        from apps.api.iac_scanner_router import router as _auto_iac_scanner_router
        app.include_router(_auto_iac_scanner_router)
        _logger.info('Mounted iac_scanner_router at /api/v1/iac (1 paths)')
    except Exception as _e:
        _logger.warning('iac_scanner_router unavailable: %s', _e)
    try:
        from apps.api.iam_policy_router import router as _auto_iam_policy_router
        app.include_router(_auto_iam_policy_router)
        _logger.info('Mounted iam_policy_router at /api/v1/iam-policy (1 paths)')
    except Exception as _e:
        _logger.warning('iam_policy_router unavailable: %s', _e)
    try:
        from apps.api.identity_risk_router import router as _auto_identity_risk_router
        app.include_router(_auto_identity_risk_router)
        _logger.info('Mounted identity_risk_router at /api/v1/identity-risk (1 paths)')
    except Exception as _e:
        _logger.warning('identity_risk_router unavailable: %s', _e)
    try:
        from apps.api.incident_comms_router import router as _auto_incident_comms_router
        app.include_router(_auto_incident_comms_router)
        _logger.info('Mounted incident_comms_router at /api/v1/incident-comms (1 paths)')
    except Exception as _e:
        _logger.warning('incident_comms_router unavailable: %s', _e)
    try:
        from apps.api.incident_kb_router import router as _auto_incident_kb_router
        app.include_router(_auto_incident_kb_router)
        _logger.info('Mounted incident_kb_router at /api/v1/incident-kb (1 paths)')
    except Exception as _e:
        _logger.warning('incident_kb_router unavailable: %s', _e)
    try:
        from apps.api.incident_lessons_router import router as _auto_incident_lessons_router
        app.include_router(_auto_incident_lessons_router)
        _logger.info('Mounted incident_lessons_router at /api/v1/incident-lessons (1 paths)')
    except Exception as _e:
        _logger.warning('incident_lessons_router unavailable: %s', _e)
    try:
        from apps.api.incident_metrics_router import router as _auto_incident_metrics_router
        app.include_router(_auto_incident_metrics_router)
        _logger.info('Mounted incident_metrics_router at /api/v1/incident-metrics (1 paths)')
    except Exception as _e:
        _logger.warning('incident_metrics_router unavailable: %s', _e)
    try:
        from apps.api.mcp_protocol_router import router as _auto_mcp_protocol_router
        app.include_router(_auto_mcp_protocol_router)
        _logger.info('Mounted mcp_protocol_router at /api/v1/mcp-protocol (1 paths)')
    except Exception as _e:
        _logger.warning('mcp_protocol_router unavailable: %s', _e)
    try:
        from apps.api.mitre_navigator_router import router as _auto_mitre_navigator_router
        app.include_router(_auto_mitre_navigator_router)
        _logger.info('Mounted mitre_navigator_router at /api/v1/mitre (1 paths)')
    except Exception as _e:
        _logger.warning('mitre_navigator_router unavailable: %s', _e)
    try:
        from apps.api.mobile_app_security_router import router as _auto_mobile_app_security_router
        app.include_router(_auto_mobile_app_security_router)
        _logger.info('Mounted mobile_app_security_router at /api/v1/mobile-app-security (1 paths)')
    except Exception as _e:
        _logger.warning('mobile_app_security_router unavailable: %s', _e)
    try:
        from apps.api.mobile_device_management_router import router as _auto_mobile_device_management_router
        app.include_router(_auto_mobile_device_management_router)
        _logger.info('Mounted mobile_device_management_router at /api/v1/mdm (1 paths)')
    except Exception as _e:
        _logger.warning('mobile_device_management_router unavailable: %s', _e)
    try:
        from apps.api.network_monitoring_router import router as _auto_network_monitoring_router
        app.include_router(_auto_network_monitoring_router)
        _logger.info('Mounted network_monitoring_router at /api/v1/network-monitoring (1 paths)')
    except Exception as _e:
        _logger.warning('network_monitoring_router unavailable: %s', _e)
    try:
        from apps.api.network_threat_router import router as _auto_network_threat_router
        app.include_router(_auto_network_threat_router)
        _logger.info('Mounted network_threat_router at /api/v1/network-threats (1 paths)')
    except Exception as _e:
        _logger.warning('network_threat_router unavailable: %s', _e)
    try:
        from apps.api.network_traffic_router import router as _auto_network_traffic_router
        app.include_router(_auto_network_traffic_router)
        _logger.info('Mounted network_traffic_router at /api/v1/network-traffic (1 paths)')
    except Exception as _e:
        _logger.warning('network_traffic_router unavailable: %s', _e)
    try:
        from apps.api.passive_dns_router import router as _auto_passive_dns_router
        app.include_router(_auto_passive_dns_router)
        _logger.info('Mounted passive_dns_router at /api/v1/passive-dns (1 paths)')
    except Exception as _e:
        _logger.warning('passive_dns_router unavailable: %s', _e)
    try:
        from apps.api.pentest_mgmt_router import router as _auto_pentest_mgmt_router
        app.include_router(_auto_pentest_mgmt_router)
        _logger.info('Mounted pentest_mgmt_router at /api/v1/pentest-mgmt (1 paths)')
    except Exception as _e:
        _logger.warning('pentest_mgmt_router unavailable: %s', _e)
    try:
        from apps.api.phishing_simulation_router import router as _auto_phishing_simulation_router
        app.include_router(_auto_phishing_simulation_router)
        _logger.info('Mounted phishing_simulation_router at /api/v1/phishing (1 paths)')
    except Exception as _e:
        _logger.warning('phishing_simulation_router unavailable: %s', _e)
    try:
        from apps.api.privacy_impact_assessment_router import router as _auto_privacy_impact_assessment_router
        app.include_router(_auto_privacy_impact_assessment_router)
        _logger.info('Mounted privacy_impact_assessment_router at /api/v1/privacy-impact (1 paths)')
    except Exception as _e:
        _logger.warning('privacy_impact_assessment_router unavailable: %s', _e)
    try:
        from apps.api.prowler_router import router as _auto_prowler_router
        app.include_router(_auto_prowler_router)
        _logger.info('Mounted prowler_router at /api/v1/prowler (1 paths)')
    except Exception as _e:
        _logger.warning('prowler_router unavailable: %s', _e)
    try:
        from apps.api.quantum_safe_crypto_router import router as _auto_quantum_safe_crypto_router
        app.include_router(_auto_quantum_safe_crypto_router)
        _logger.info('Mounted quantum_safe_crypto_router at /api/v1/quantum-crypto (1 paths)')
    except Exception as _e:
        _logger.warning('quantum_safe_crypto_router unavailable: %s', _e)
    try:
        from apps.api.red_team_router import router as _auto_red_team_router
        app.include_router(_auto_red_team_router)
        _logger.info('Mounted red_team_router at /api/v1/red-team (1 paths)')
    except Exception as _e:
        _logger.warning('red_team_router unavailable: %s', _e)
    try:
        from apps.api.risk_aggregator_router import router as _auto_risk_aggregator_router
        app.include_router(_auto_risk_aggregator_router)
        _logger.info('Mounted risk_aggregator_router at /api/v1/risk-aggregator (1 paths)')
    except Exception as _e:
        _logger.warning('risk_aggregator_router unavailable: %s', _e)
    try:
        from apps.api.risk_quantification_engine_router import router as _auto_risk_quantification_engine_router
        app.include_router(_auto_risk_quantification_engine_router)
        _logger.info('Mounted risk_quantification_engine_router at /api/v1/risk-quant (1 paths)')
    except Exception as _e:
        _logger.warning('risk_quantification_engine_router unavailable: %s', _e)
    try:
        from apps.api.risk_quantification_router import router as _auto_risk_quantification_router
        app.include_router(_auto_risk_quantification_router)
        _logger.info('Mounted risk_quantification_router at /api/v1/risk-quantification (1 paths)')
    except Exception as _e:
        _logger.warning('risk_quantification_router unavailable: %s', _e)
    try:
        from apps.api.security_architecture_review_router import router as _auto_security_architecture_review_router
        app.include_router(_auto_security_architecture_review_router)
        _logger.info('Mounted security_architecture_review_router at /api/v1/arch-review (1 paths)')
    except Exception as _e:
        _logger.warning('security_architecture_review_router unavailable: %s', _e)
    try:
        from apps.api.security_awareness_gamification_router import router as _auto_security_awareness_gamification_router
        app.include_router(_auto_security_awareness_gamification_router)
        _logger.info('Mounted security_awareness_gamification_router at /api/v1/awareness-gamification (1 paths)')
    except Exception as _e:
        _logger.warning('security_awareness_gamification_router unavailable: %s', _e)
    try:
        from apps.api.security_change_management_router import router as _auto_security_change_management_router
        app.include_router(_auto_security_change_management_router)
        _logger.info('Mounted security_change_management_router at /api/v1/change-management (1 paths)')
    except Exception as _e:
        _logger.warning('security_change_management_router unavailable: %s', _e)
    try:
        from apps.api.security_dependency_risk_router import router as _auto_security_dependency_risk_router
        app.include_router(_auto_security_dependency_risk_router)
        _logger.info('Mounted security_dependency_risk_router at /api/v1/dependency-risk (1 paths)')
    except Exception as _e:
        _logger.warning('security_dependency_risk_router unavailable: %s', _e)
    try:
        from apps.api.security_health_scorecard_router import router as _auto_security_health_scorecard_router
        app.include_router(_auto_security_health_scorecard_router)
        _logger.info('Mounted security_health_scorecard_router at /api/v1/health-scorecard (1 paths)')
    except Exception as _e:
        _logger.warning('security_health_scorecard_router unavailable: %s', _e)
    try:
        from apps.api.security_metrics_aggregator_router import router as _auto_security_metrics_aggregator_router
        app.include_router(_auto_security_metrics_aggregator_router)
        _logger.info('Mounted security_metrics_aggregator_router at /api/v1/metrics-aggregator (1 paths)')
    except Exception as _e:
        _logger.warning('security_metrics_aggregator_router unavailable: %s', _e)
    try:
        from apps.api.security_posture_scoring_router import router as _auto_security_posture_scoring_router
        app.include_router(_auto_security_posture_scoring_router)
        _logger.info('Mounted security_posture_scoring_router at /api/v1/posture-scoring (1 paths)')
    except Exception as _e:
        _logger.warning('security_posture_scoring_router unavailable: %s', _e)
    try:
        from apps.api.security_posture_trend_router import router as _auto_security_posture_trend_router
        app.include_router(_auto_security_posture_trend_router)
        _logger.info('Mounted security_posture_trend_router at /api/v1/posture-trends (1 paths)')
    except Exception as _e:
        _logger.warning('security_posture_trend_router unavailable: %s', _e)
    try:
        from apps.api.threat_feed_subscription_router import router as _auto_threat_feed_subscription_router
        app.include_router(_auto_threat_feed_subscription_router)
        _logger.info('Mounted threat_feed_subscription_router at /api/v1/feed-subscriptions (1 paths)')
    except Exception as _e:
        _logger.warning('threat_feed_subscription_router unavailable: %s', _e)
    try:
        from apps.api.threat_hunting_playbook_router import router as _auto_threat_hunting_playbook_router
        app.include_router(_auto_threat_hunting_playbook_router)
        _logger.info('Mounted threat_hunting_playbook_router at /api/v1/hunting-playbooks (1 paths)')
    except Exception as _e:
        _logger.warning('threat_hunting_playbook_router unavailable: %s', _e)
    try:
        from apps.api.threat_intel_enrichment_router import router as _auto_threat_intel_enrichment_router
        app.include_router(_auto_threat_intel_enrichment_router)
        _logger.info('Mounted threat_intel_enrichment_router at /api/v1/intel-enrichment (1 paths)')
    except Exception as _e:
        _logger.warning('threat_intel_enrichment_router unavailable: %s', _e)
    try:
        from apps.api.user_access_review_router import router as _auto_user_access_review_router
        app.include_router(_auto_user_access_review_router)
        _logger.info('Mounted user_access_review_router at /api/v1/access-reviews (1 paths)')
    except Exception as _e:
        _logger.warning('user_access_review_router unavailable: %s', _e)
